    ...
    <div class="body-privacy">
      ...
      <ol type="a">
        <li>
          ...
          materials (information or software) on LastMinuteTaxes's web site for
        ...
        <li>
          ...
          restrictions and may be terminated by LastMinuteTaxes at any time.
      ...
      <ol type="a">
        <li>
          The materials on LastMinuteTaxes's web site are provided "as is".
          LastMinuteTaxes makes no warranties, expressed or implied, and hereby
          disclaims and negates all other warranties, including without
          limitation, implied warranties or conditions of merchantability,
          fitness for a particular purpose, or non-infringement of intellectual
          property or other violation of rights. Further, LastMinuteTaxes does
      ...
      <p>
        In no event shall LastMinuteTaxes or its suppliers be liable for any
        damages (including, without limitation, damages for loss of data or
        profit, or due to business interruption,) arising out of the use or
        inability to use the materials on LastMinuteTaxes's Internet site, even
        if LastMinuteTaxes or a LastMinuteTaxes authorized representative has
      ...
      <p>
        The materials appearing on LastMinuteTaxes's web site could include
        technical, typographical, or photographic errors. LastMinuteTaxes does
        not warrant that any of the materials on its web site are accurate,
        complete, or current. LastMinuteTaxes may make changes to the materials
        contained on its web site at any time without notice. LastMinuteTaxes
      ...
      <p>
        LastMinuteTaxes has not reviewed all of the sites linked to its Internet
        web site and is not responsible for the contents of any such linked
        site. The inclusion of any link does not imply endorsement by
        LastMinuteTaxes of the site. Use of any such linked web site is at the
        user's own risk.
      </p>
      ...
      <p>
        LastMinuteTaxes may revise these terms of use for its web site at any
      ...
      <p>
        Any claim relating to LastMinuteTaxes's web site shall be governed by
...
<style>
/* Add styling for the privacy policy page if needed */
.body-privacy {
  text-align: left;
  padding: 10px;
}
